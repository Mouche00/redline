...
const Sidebar = forwardRef(({ children, hidden = 1, disabled = 0 }, ref) => {
    ...
    return (
        <div ref={reference} className={`relative transition-all ${hidden ? 'translate-x-[100%]' : ''} w-full h-full top-0 left-0 bg-contain bg-repeat bg-center z-20`} style={{backgroundImage: `url(${Texture})`}}>
